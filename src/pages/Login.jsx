...
const Login = () => {
 ...
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                                    ...
                                    <button disabled className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100 disabled:hover:border-gray-300 disabled:active:bg-transparent">
                                        <div className="relative flex items-center space-x-4 justify-center">
                                            ...
                                            <span className="block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 sm:text-base">Continue with Github</span>
                                        </div>
                                    </button>
                                    <button disabled className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
                                     hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100 disabled:hover:border-gray-300 disabled:active:bg-transparent">
                                ...
                                <div className="mt-8 space-y-4 text-gray-600 text-center sm:-mb-8 pb-8">
